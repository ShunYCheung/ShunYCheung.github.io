...
![These are draws from a matern-3/2 kernel. Notice how it is much more jagged then the radial basis function kernel]({{ '/assets/images/matern_3_2_kernel_example.gif' | relative_url}})
