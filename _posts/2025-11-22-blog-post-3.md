...
But now, we have a problem where we need a infinitely large matrix to represent this higher dimensional space. However, due to a unique property of Hilbert spaces, where any inner product of matrices can be replaced by a function as long as it returns a positive semi-definite matrix. This function is the kernel function,
