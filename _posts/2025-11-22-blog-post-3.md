...
The covariance matrix describe how each data point is correlated with each other. As a result, you can generate an infinite number of functions that could descrive the data. 

![]({{ C:\Users\Shun\personal_projects\github_pages\ShunYCheung.github.io\_posts\correlation_2_points.gif| relative_url }})
