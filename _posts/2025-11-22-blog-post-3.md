...
![This animation can help you visualise how the multivariate Gaussian distribution generate functions to describe the data.]({{'correlation_2_points.gif' | relative_url}})
