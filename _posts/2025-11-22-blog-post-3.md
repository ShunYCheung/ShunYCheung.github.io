...
![Here is an example taken from the [celerite example](https://celerite.readthedocs.io/en/stable/tutorials/first/) with simulated data. We have data except for a region between 3.8 s and 5.5 s. Here the GP is conditioned onto the data and we see that for the missing data points, there is a prediction made by the GP.]({{ '/assets/images/GP_example.png' | relative_url}})
