...
- [George](https://george.readthedocs.io/en/latest/): python libary that implements GPs. You can use both stationary and non-stationary kernels. It primarily use two solvers, which are scipy's Cholesky implementation and Sivaram Amambikasaran's HOLDLR algorithm.
