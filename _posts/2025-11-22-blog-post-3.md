...
$$\begin{align}
\mathcal{L}(d|X,\sigma, w) = \frac{1}{(2\pi\sigma^2_n)^{n/2}}\exp(-\frac{|d-X^Tw|^2}{2\sigma^2})
\end{align}$$
...
$$\begin{align}
p(y|X) = \int^\inf_{-\inf}\frac{1}{2\pi\Sigma_p}\exp(-\frac{w^T\Sigma_p w}{2})\frac{1}{(2\pi\sigma^2_n)^{n/2}}\exp(-\frac{y-X^Tw}{2\sigma_n^2})
\end{align}$$

$$\begin{align}
\int^\inf_{-\inf}\exp(-\frac{1}{2}|w-h|^T\Sigma^{-1}|w-h|)dw = |2\pi\Sigma|^{1/2}
\end{align}$$

$$\begin{align}
p(y|\theta) = \frac{1}{|2\pi()|^{1/2}}
\end{align}$$
