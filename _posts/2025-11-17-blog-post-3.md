...
$$\begin{align}
p(w) = \frac{1}{2\pi\Lambda} \exp\left(-\frac{1}{2}w^T\Lambda w \right)
\end{align}$$
...
$$\begin{align}
p(y|\theta) = \int^\infty_{-\infty} \frac{1}{(2\pi C)}\exp\left(-\frac{1}{2}|y-f(\theta)|^T C^{-1}|y-f(\theta)|\right)\frac{1}{2\pi\Lambda} \exp\left(-\frac{1}{2}w^T\Lambda w \right)
\end{align}$$

which becomes

$$\begin{align}
p(y|\theta) = \int^\infty_{-\infty}\frac{1}{(2\pi\Lambda)(2\pi C)}\exp\left(-\frac{1}{2}(w^T\Lambda w+|y-f(\theta)|^TC^{-1}|y-f(\theta))|\right)
\end{align}$$
