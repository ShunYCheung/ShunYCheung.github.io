...
$$\begin{align}
\mathcal{L}(y|\vec{w}, A ,\sigma) = \frac{1}{(2\pi C)}\exp\left(-\frac{1}{2}|y-A\vec{w}|^T C^{-1}|y-A\vec{w}|\right)
\end{align}$$
...
$$\begin{align}
p(\vec{w}) = \frac{1}{2\pi\Lambda} \exp\left(-\frac{1}{2}\vec{w}^T\Lambda \vec{w} \right)
\end{align}$$

According the Bayes' theorem, we can write the posterior as

$$\begin{align}
p(\vec{w}|y, X) \propto \exp\left(-\frac{1}{2}|y-A\vec{w}|^T C^{-1}|y-A\vec{w}|\right)\exp\left(-\frac{1}{2}\vec{w}^T\Lambda \vec{w} \right)
\end{align}$$
