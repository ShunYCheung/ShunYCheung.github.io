...
Using the [Woodbury identity matrix](https://en.wikipedia.org/wiki/Woodbury_matrix_identity)
...
$$\begin{align}
p(y_*|x_*, A) = \mathcal{N}(\phi(x_*)^T\Sigma A^T(K+\sigma^2)^{-1}y, \phi(x_*)\Lambda^{-1}\phi(x_*))
\end{align}$$
