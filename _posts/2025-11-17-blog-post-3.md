...
# Motivation: A straight line model
We start with a simple linear model within the Bayesian framework. We will define the model as 
$$\begin{align}
...
This is the data and the straight line fit. It looks pretty good.
...
We can enhance this model by projecting the inputs into a higher dimensional feature space and apply our model there. We can apply a "kernel trick" to carry out the computation implicitly in the high dimensional space.
