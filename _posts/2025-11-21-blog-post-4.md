...
where $$T$$ is known as a translation function. Another architecture called real non-volume preserving (R-NVP) flow proposed by Dinh *et al*. (2015) uses an affine coupling function:
