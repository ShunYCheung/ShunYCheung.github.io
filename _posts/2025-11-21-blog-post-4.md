...
In this blog post, I have introduced the basics of a normalising flow. Using a composition of simple bijective function, we can express a complicated distribution from a simple distribution. This is an immensely useful method, which has applications in astrophysics and beyond.  
