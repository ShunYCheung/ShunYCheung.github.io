...
We will use a normalising flow to fit the two moons dataset in [sklearn.dataset](https://scikit-learn.org/stable/modules/generated/sklearn.datasets.make_moons.html.).
